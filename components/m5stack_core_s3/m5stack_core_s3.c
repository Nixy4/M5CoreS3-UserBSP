...
i2c_master_bus_handle_t bsp_i2c_get_bus_handle()
{
    return i2c_handle;
}

i2c_master_dev_handle_t bsp_i2c_get_dev_handle_axp2101()
{
    return axp2101_h;
}

i2c_master_dev_handle_t bsp_i2c_get_dev_handle_aw9523()
{
    return aw9523_h;
}
